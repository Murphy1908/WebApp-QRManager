...
<body>
	...
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
			<sys:treeselect id="team" name="team.id" value="${user.team.id}" labelName="team.name" labelValue="${user.team.name}"
					title="班组" url="/sys/office/treeData?type=3" cssClass="required"/>
			</div>
		</div>
		<div class="control-group">
